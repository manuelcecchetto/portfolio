...
export function switchLocalePath(currentPath: string, targetLocale: SiteLocale): string {
  ...
  // Tags are translated per locale, so a tag archive has no counterpart in another language.
  return localizePath(targetLocale, path.startsWith("/blog/tags/") ? "/blog/" : path);
}
...
const enCopy: SiteCopy = {
  ...
  projectsPage: {
    ...
    heroText: "Harnesses, protocols and small tools. Mostly for agents, sometimes just for me.",
  ...
  projectDetailsPanel: {
    ...
    noExternalLinks: "The source is private for now.",
  },
  blogPage: {
    eyebrow: "Blog",
    heroTitle: "Writing.",
    heroText: "Notes on agents, harnesses and the plumbing that makes them trustworthy. Mostly things I learned the hard way.",
  ...
  blogPost: {
    ...
    tagsAria: "Post tags",
    continueReadingTitle: "Keep reading",
...
const itCopy: SiteCopy = {
  ...
  projectsPage: {
    ...enCopy.projectsPage,
    eyebrow: "Progetti",
    heroTitle: "Cose che ho costruito.",
    heroText: "Harness, protocolli e piccoli tool. Per lo più per agenti, a volte solo per me.",
  ...
  projectDetailsPanel: {
    ...
    noExternalLinks: "Il codice per ora è privato.",
  },
  blogPage: {
    ...enCopy.blogPage,
    heroTitle: "Scritti.",
    heroText: "Appunti su agenti, harness e sull'idraulica che li rende affidabili. Soprattutto cose imparate a mie spese.",
...
const deCopy: SiteCopy = {
  ...
  projectsPage: {
    ...enCopy.projectsPage,
    eyebrow: "Projekte",
    heroTitle: "Dinge, die ich gebaut habe.",
    heroText: "Harnesses, Protokolle und kleine Tools. Meist für Agenten, manchmal nur für mich.",
  ...
  projectDetailsPanel: {
    ...
    noExternalLinks: "Der Code ist vorerst privat.",
  },
  blogPage: {
    ...enCopy.blogPage,
    heroTitle: "Texte.",
    heroText: "Notizen über Agenten, Harnesses und die Technik, die sie vertrauenswürdig macht. Meist auf die harte Tour gelernt.",
...
const frCopy: SiteCopy = {
  ...
  projectsPage: {
    ...
    heroText: "Des harness, des protocoles et de petits outils. Surtout pour des agents, parfois juste pour moi.",
  ...
  projectDetailsPanel: {
    ...
    noExternalLinks: "Le code est privé pour l'instant.",
  },
  blogPage: {
    ...enCopy.blogPage,
    heroTitle: "Écrits.",
    heroText: "Des notes sur les agents, les harness et la plomberie qui les rend fiables. Surtout des choses apprises à la dure.",
...
const zhCopy: SiteCopy = {
  ...
  projectsPage: {
    ...
    eyebrow: "项目",
    heroTitle: "我做过的东西。",
    heroText: "Harness、协议和小工具。大多为智能体而做，有时只是为了自己。",
  ...
  projectDetailsPanel: {
    ...
    viewRepository: "查看仓库",
    openLiveDemo: "打开在线演示",
    noExternalLinks: "源码暂未公开。",
  },
  blogPage: {
    ...enCopy.blogPage,
    heroTitle: "文章。",
    heroText: "关于智能体、harness，以及让它们值得信赖的底层工程的笔记。大多是踩坑后学到的。",
...
const hiCopy: SiteCopy = {
  ...
  projectsPage: {
    ...enCopy.projectsPage,
    eyebrow: "प्रोजेक्ट्स",
    heroTitle: "जो मैंने बनाया।",
    heroText: "हार्नेस, प्रोटोकॉल और छोटे टूल। ज़्यादातर एजेंट्स के लिए, कभी-कभी सिर्फ़ अपने लिए।",
  ...
  projectDetailsPanel: {
    ...
    noExternalLinks: "सोर्स अभी निजी है।",
  },
  blogPage: {
    ...enCopy.blogPage,
    heroTitle: "लेखन।",
    heroText: "एजेंट्स, हार्नेस और उन्हें भरोसेमंद बनाने वाली प्लंबिंग पर नोट्स। ज़्यादातर मुश्किल से सीखी बातें।",
